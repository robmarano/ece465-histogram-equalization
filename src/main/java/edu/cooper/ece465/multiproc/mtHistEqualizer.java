...
public class mtHistEqualizer implements Runnable {
    ...
    mtHistEqualizer(int id, int total_number, int[] histogram, int[] cdf, int[] histogram_equalized, int width, int height){
